...
%% %% Parameter Settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Celltype='FB Spontaneous Ca TRPV4_New_Noaverage';
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Filepath{1} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\SpontaneousTRPV4\Arachnoid FBS';
Filepath{2} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\SpontaneousTRPV4\BFB1b FBs';
Filepath{3} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\SpontaneousTRPV4\Endfeet of perivascular FBs';


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
% Premark the time range of locomotion
AFBSLcmtRangeMarks.DataNames{1} = 'Mouse180_locb_20241120_arc_no6';
AFBSLcmtRangeMarks.LcmtReg{1} =[30 60];
AFBSLcmtRangeMarks.BL{1} = [1 16];
AFBSLcmtRangeMarks.avgstdThld{1} = 2;

AFBSLcmtRangeMarks.DataNames{2} = 'Mouse180_locb_20241120_arc_no7';
AFBSLcmtRangeMarks.LcmtReg{2} =[80 NaN];
AFBSLcmtRangeMarks.BL{2} = [60 80];
AFBSLcmtRangeMarks.avgstdThld{2} = 2;

AFBSLcmtRangeMarks.DataNames{3} = 'Mouse182_loca_20241120_arc_no4';
AFBSLcmtRangeMarks.LcmtReg{3} =[NaN NaN];
AFBSLcmtRangeMarks.BL{3} = [1 45];
AFBSLcmtRangeMarks.avgstdThld{3} = 2;

AFBSLcmtRangeMarks.DataNames{4} = 'Mouse182_locb_20241120_arc_no7';
AFBSLcmtRangeMarks.LcmtReg{4} = [15 40];
AFBSLcmtRangeMarks.BL{4} = [60 120];
AFBSLcmtRangeMarks.avgstdThld{4} = 2;

AFBSLcmtRangeMarks.DataNames{5} = 'Mouse182_loce_20241120_arc_no13';
AFBSLcmtRangeMarks.LcmtReg{5} = [80 120];
AFBSLcmtRangeMarks.BL{5} = [20 80];     
AFBSLcmtRangeMarks.avgstdThld{5} = 2;

AFBSLcmtRangeMarks.DataNames{6} = 'Mouse182_loce_20241120_arc_no14';
AFBSLcmtRangeMarks.LcmtReg{6} = [40 60];
AFBSLcmtRangeMarks.BL{6} = [1 40];
AFBSLcmtRangeMarks.avgstdThld{6} = 2;

AFBSLcmtRangeMarks.DataNames{7} = 'Mouse190_loca_20241121_arc_no1';
AFBSLcmtRangeMarks.LcmtReg{7} = [NaN NaN];
AFBSLcmtRangeMarks.BL{7} = [1 70];
AFBSLcmtRangeMarks.avgstdThld{7} = 2;

AFBSLcmtRangeMarks.DataNames{8} = 'Mouse190_locc_20241121_arc_no13';
AFBSLcmtRangeMarks.LcmtReg{8} = [40 60];
AFBSLcmtRangeMarks.BL{8} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{8} = 2;

AFBSLcmtRangeMarks.DataNames{9} = 'Mouse43_loca_20250218_arc_6';
AFBSLcmtRangeMarks.LcmtReg{9} = [NaN NaN];
AFBSLcmtRangeMarks.BL{9} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{9} = 2;

AFBSLcmtRangeMarks.DataNames{10} = 'Mouse43_locb_20250218_arc_7';
AFBSLcmtRangeMarks.LcmtReg{10} = [40 50];
AFBSLcmtRangeMarks.BL{10} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{10} = 2;

AFBSLcmtRangeMarks.DataNames{11} = 'Mouse43_locb_20250218_arc_14';
AFBSLcmtRangeMarks.LcmtReg{11} = [NaN NaN];
AFBSLcmtRangeMarks.BL{11} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{11} = 2;

AFBSLcmtRangeMarks.DataNames{12} = 'Mouse43_locc_20250218_arc_15';
AFBSLcmtRangeMarks.LcmtReg{12} = [NaN NaN];
AFBSLcmtRangeMarks.BL{12} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{12} = 2;

AFBSLcmtRangeMarks.DataNames{13} = 'Mouse80_loca_20250218_arc_1';
AFBSLcmtRangeMarks.LcmtReg{13} = [NaN NaN];
AFBSLcmtRangeMarks.BL{13} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{13} = 2;

AFBSLcmtRangeMarks.DataNames{14} = 'Mouse80_locc_20250218_arc_10';
AFBSLcmtRangeMarks.LcmtReg{14} = [0.1 20];
AFBSLcmtRangeMarks.BL{14} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{14} = 2;



BFB1b_sasLcmtRangeMarks.DataNames{1} = 'Mouse180_locb_20241120_BFB1b_no6_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{1} =[30 60];
BFB1b_sasLcmtRangeMarks.BL{1} = [1 20];
BFB1b_sasLcmtRangeMarks.avgstdThld{1} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{2} = 'Mouse180_locb_20241120_BFB1b_no7_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{2} =[80 120];
BFB1b_sasLcmtRangeMarks.BL{2} = [60 80];
BFB1b_sasLcmtRangeMarks.avgstdThld{2} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{3} = 'Mouse180_locd_20241120_BFB1b_no14_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{3} =[30 50];
BFB1b_sasLcmtRangeMarks.BL{3} = [50 100];
BFB1b_sasLcmtRangeMarks.avgstdThld{3} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{4} = 'Mouse182_loca_20241120_BFB1b_no4_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{4} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{4} = [1 40];
BFB1b_sasLcmtRangeMarks.avgstdThld{4} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{5} = 'Mouse182_locb_20241120_BFB1b_no7_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{5} =[15 40];
BFB1b_sasLcmtRangeMarks.BL{5} = [1 40];
BFB1b_sasLcmtRangeMarks.avgstdThld{5} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{6} = 'Mouse182_locb_20241120_BFB1b_no7_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{6} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{6} = [1 80];
BFB1b_sasLcmtRangeMarks.avgstdThld{6} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{7} = 'Mouse182_loce_20241120_BFB1b_no13_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{7} =[80 120];
BFB1b_sasLcmtRangeMarks.BL{7} = [20 40];
BFB1b_sasLcmtRangeMarks.avgstdThld{7} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{8} = 'Mouse190_loca_20241121_BFB1b_no1_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{8} =[60 72];
BFB1b_sasLcmtRangeMarks.BL{8} = [10 30];
BFB1b_sasLcmtRangeMarks.avgstdThld{8} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{9} = 'Mouse190_locc_20241121_BFB1b_no13_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{9} =[40 60];
BFB1b_sasLcmtRangeMarks.BL{9} = [15 25];
BFB1b_sasLcmtRangeMarks.avgstdThld{9} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{10} = 'Mouse43_loca_20250218_BFB1b_6_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{10} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{10} = [15 25];
BFB1b_sasLcmtRangeMarks.avgstdThld{10} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{11} = 'Mouse43_locb_20250218_BFB1b_7_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{11} =[40 50];
BFB1b_sasLcmtRangeMarks.BL{11} = [15 25];
BFB1b_sasLcmtRangeMarks.avgstdThld{11} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{12} = 'Mouse43_locb_20250218_BFB1b_14_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{12} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{12} = [15 25];
BFB1b_sasLcmtRangeMarks.avgstdThld{12} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{13} = 'Mouse43_locc_20250218_BFB1b_15_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{13} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{13} = [15 25];
BFB1b_sasLcmtRangeMarks.avgstdThld{13} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{14} = 'Mouse80_locc_20250218_BFB1b_1_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{14} =[0.5 20];
BFB1b_sasLcmtRangeMarks.BL{14} = [15 25];
BFB1b_sasLcmtRangeMarks.avgstdThld{14} = 2;

BFB1b_sasLcmtRangeMarks.DataNames{15} = 'Mouse43_locc_20250218_BFB1b_15_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{15} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{15} = [15 25];
BFB1b_sasLcmtRangeMarks.avgstdThld{15} = 2;
...
BFB1b_psLcmtRangeMarks.DataNames{1} = 'Mouse180_locc_20241120_pial sheath_no11';
BFB1b_psLcmtRangeMarks.LcmtReg{1} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{1} = [1 20];
BFB1b_psLcmtRangeMarks.avgstdThld{1} = 2;

BFB1b_psLcmtRangeMarks.DataNames{2} = 'Mouse180_locd_20241120_pial sheath_no14_left';
BFB1b_psLcmtRangeMarks.LcmtReg{2} =[30 50];
BFB1b_psLcmtRangeMarks.BL{2} = [60 110];
BFB1b_psLcmtRangeMarks.avgstdThld{2} = 2;

BFB1b_psLcmtRangeMarks.DataNames{3} = 'Mouse180_locd_20241120_pial sheath_no14_right';
BFB1b_psLcmtRangeMarks.LcmtReg{3} =[30 50];
BFB1b_psLcmtRangeMarks.BL{3} = [60 80];
BFB1b_psLcmtRangeMarks.avgstdThld{3} = 2;

BFB1b_psLcmtRangeMarks.DataNames{4} = 'Mouse182_loca_20241120_pial sheath_no4_left';
BFB1b_psLcmtRangeMarks.LcmtReg{4} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{4} = [1 40];
BFB1b_psLcmtRangeMarks.avgstdThld{4} = 2;

BFB1b_psLcmtRangeMarks.DataNames{5} = 'Mouse182_loca_20241120_pial sheath_no4_right';
BFB1b_psLcmtRangeMarks.LcmtReg{5} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{5} = [40 60];
BFB1b_psLcmtRangeMarks.avgstdThld{5} = 2;

BFB1b_psLcmtRangeMarks.DataNames{6} = 'Mouse182_locb_20241120_pial sheath_no7';
BFB1b_psLcmtRangeMarks.LcmtReg{6} =[18 40];
BFB1b_psLcmtRangeMarks.BL{6} = [1 80];
BFB1b_psLcmtRangeMarks.avgstdThld{6} = 2;

BFB1b_psLcmtRangeMarks.DataNames{7} = 'Mouse182_loce_20241120_pial sheath_no13';
BFB1b_psLcmtRangeMarks.LcmtReg{7} =[80 120];
BFB1b_psLcmtRangeMarks.BL{7} = [1 50];
BFB1b_psLcmtRangeMarks.avgstdThld{7} = 2;

BFB1b_psLcmtRangeMarks.DataNames{8} = 'Mouse182_loce_20241120_pial sheath_no14';
BFB1b_psLcmtRangeMarks.LcmtReg{8} =[45 60];
BFB1b_psLcmtRangeMarks.BL{8} = [10 30];
BFB1b_psLcmtRangeMarks.avgstdThld{8} = 2;

BFB1b_psLcmtRangeMarks.DataNames{9} = 'Mouse190_loca_20241121_pial sheath_no1';
BFB1b_psLcmtRangeMarks.LcmtReg{9} =[60 70];
BFB1b_psLcmtRangeMarks.BL{9} = [1 20];
BFB1b_psLcmtRangeMarks.avgstdThld{9} = 2;

BFB1b_psLcmtRangeMarks.DataNames{10} = 'Mouse190_locb_20241121_pial sheath_no6';
BFB1b_psLcmtRangeMarks.LcmtReg{10} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{10} = [10 18];
BFB1b_psLcmtRangeMarks.avgstdThld{10} = 2;

BFB1b_psLcmtRangeMarks.DataNames{11} = 'Mouse190_locc_20241121_pial sheath_no13';
BFB1b_psLcmtRangeMarks.LcmtReg{11} =[40 60];
BFB1b_psLcmtRangeMarks.BL{11} = [20 32];
BFB1b_psLcmtRangeMarks.avgstdThld{11} = 2;

BFB1b_psLcmtRangeMarks.DataNames{12} = 'Mouse43_locb_20250218_pial sheath_7_left';
BFB1b_psLcmtRangeMarks.LcmtReg{12} =[40 50];
BFB1b_psLcmtRangeMarks.BL{12} = [20 32];
BFB1b_psLcmtRangeMarks.avgstdThld{12} = 2;

BFB1b_psLcmtRangeMarks.DataNames{13} = 'Mouse43_locb_20250218_pial sheath_14_left';
BFB1b_psLcmtRangeMarks.LcmtReg{13} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{13} = [20 32];
BFB1b_psLcmtRangeMarks.avgstdThld{13} = 2;

BFB1b_psLcmtRangeMarks.DataNames{14} = 'Mouse43_locc_20250218_pial sheath_15_left';
BFB1b_psLcmtRangeMarks.LcmtReg{14} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{14} = [20 32];
BFB1b_psLcmtRangeMarks.avgstdThld{14} = 2;

BFB1b_psLcmtRangeMarks.DataNames{15} = 'Mouse43_locc_20250218_pial sheath_15_right';
BFB1b_psLcmtRangeMarks.LcmtReg{15} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{15} = [20 32];
BFB1b_psLcmtRangeMarks.avgstdThld{15} = 2;

BFB1b_psLcmtRangeMarks.DataNames{16} = 'Mouse80_loca_20250218_pial sheath_1_left';
BFB1b_psLcmtRangeMarks.LcmtReg{16} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{16} = [20 32];
BFB1b_psLcmtRangeMarks.avgstdThld{16} = 2;

BFB1b_psLcmtRangeMarks.DataNames{17} = 'Mouse80_locc_20250218_pial sheath_10_left';
BFB1b_psLcmtRangeMarks.LcmtReg{17} =[0.5 20];
BFB1b_psLcmtRangeMarks.BL{17} = [20 32];
