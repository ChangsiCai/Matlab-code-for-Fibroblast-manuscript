...
%% %% Parameter Settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Celltype='FB Spontaneous Ca LPS_New_Noaverage';
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Filepath{1} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\SpontaneousLPS\Arachnoid FBS';
Filepath{2} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\SpontaneousLPS\BFB1b FBs';
Filepath{3} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\SpontaneousLPS\Endfeet of perivascular FBs';
...
AFBSLcmtRangeMarks.DataNames{1} = 'Mouse15_Locb_20250117_#7';
AFBSLcmtRangeMarks.LcmtReg{1} =[70 80];
AFBSLcmtRangeMarks.BL{1} = [50 70];
AFBSLcmtRangeMarks.avgstdThld{1} = 2;
AFBSLcmtRangeMarks.DataNames{2} = 'Mouse15_Locb_20250117_#10';
AFBSLcmtRangeMarks.LcmtReg{2} =[80 NaN];
AFBSLcmtRangeMarks.BL{2} = [65 80];
AFBSLcmtRangeMarks.avgstdThld{2} = 2.2;
AFBSLcmtRangeMarks.DataNames{3} = 'Mouse15_Locc_20250117_#15';
AFBSLcmtRangeMarks.LcmtReg{3} =[80 NaN];
AFBSLcmtRangeMarks.BL{3} = [1 80];
AFBSLcmtRangeMarks.avgstdThld{3} = 2;
AFBSLcmtRangeMarks.DataNames{4} = 'Mouse15_Locc_20250117_#17';
AFBSLcmtRangeMarks.LcmtReg{4} = [NaN NaN];
AFBSLcmtRangeMarks.BL{4} = [1 70];
AFBSLcmtRangeMarks.avgstdThld{4} = 2;
AFBSLcmtRangeMarks.DataNames{5} = 'Mouse15_Locc_20250117_#18';
AFBSLcmtRangeMarks.LcmtReg{5} = [40 50];
AFBSLcmtRangeMarks.BL{5} = [1 40];     
AFBSLcmtRangeMarks.avgstdThld{5} = 2;
AFBSLcmtRangeMarks.DataNames{6} = 'Mouse39_Locb_200250117_#3';
AFBSLcmtRangeMarks.LcmtReg{6} = [0.5 5];
AFBSLcmtRangeMarks.BL{6} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{6} = 2;
AFBSLcmtRangeMarks.DataNames{7} = 'Mouse39_Locd_20250117_#7';
AFBSLcmtRangeMarks.LcmtReg{7} = [90 NaN];
AFBSLcmtRangeMarks.BL{7} = [20 40];
AFBSLcmtRangeMarks.avgstdThld{7} = 2;
AFBSLcmtRangeMarks.DataNames{8} = 'Mouse39_Loce_20250117_#9';
AFBSLcmtRangeMarks.LcmtReg{8} = [80 90];
AFBSLcmtRangeMarks.BL{8} = [60 80];
AFBSLcmtRangeMarks.avgstdThld{8} = 2;
AFBSLcmtRangeMarks.DataNames{9} = 'Mouse39_Loce_20250117_#10';
AFBSLcmtRangeMarks.LcmtReg{9} = [NaN NaN];
AFBSLcmtRangeMarks.BL{9} = [1 20];
AFBSLcmtRangeMarks.avgstdThld{9} = 2.5;
AFBSLcmtRangeMarks.DataNames{10} = 'Mouse214_Loca_20250114_#4';
AFBSLcmtRangeMarks.LcmtReg{10} = [70 NaN];
AFBSLcmtRangeMarks.BL{10} = [10 30];
AFBSLcmtRangeMarks.avgstdThld{10} = 2;
AFBSLcmtRangeMarks.DataNames{11} = 'Mouse214_Locb_20250114_#11';
AFBSLcmtRangeMarks.LcmtReg{11} = [NaN NaN];
AFBSLcmtRangeMarks.BL{11} = [50 70];
AFBSLcmtRangeMarks.avgstdThld{11} = 2;
AFBSLcmtRangeMarks.DataNames{12} = 'Mouse214_Locc_20250114_#16';
AFBSLcmtRangeMarks.LcmtReg{12} = [5 30];
AFBSLcmtRangeMarks.BL{12} = [30 55];
AFBSLcmtRangeMarks.avgstdThld{12} = 2;
AFBSLcmtRangeMarks.DataNames{13} = 'Mouse214_Locd_20250114_#19';
AFBSLcmtRangeMarks.LcmtReg{13} = [60 70;80 NaN];
AFBSLcmtRangeMarks.BL{13} = [1 30];
AFBSLcmtRangeMarks.avgstdThld{13} = 2;




BFB1b_sasLcmtRangeMarks.DataNames{1} = 'Mouse15_Locc_20250117_#15';
BFB1b_sasLcmtRangeMarks.LcmtReg{1} =[80 NaN];
BFB1b_sasLcmtRangeMarks.BL{1} = [10 30];
BFB1b_sasLcmtRangeMarks.avgstdThld{1} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{2} = 'Mouse15_Locc_20250117_#17';
BFB1b_sasLcmtRangeMarks.LcmtReg{2} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{2} = [1 60];
BFB1b_sasLcmtRangeMarks.avgstdThld{2} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{3} = 'Mouse15_Locc_20250117_#18';
BFB1b_sasLcmtRangeMarks.LcmtReg{3} =[40 50];
BFB1b_sasLcmtRangeMarks.BL{3} = [10 40];
BFB1b_sasLcmtRangeMarks.avgstdThld{3} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{4} = 'Mouse39_Locb_20250117_#3_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{4} =[0.5 5];
BFB1b_sasLcmtRangeMarks.BL{4} = [20 45];
BFB1b_sasLcmtRangeMarks.avgstdThld{4} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{5} = 'Mouse39_Locb_20250117_#3_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{5} =[0.5 5];
BFB1b_sasLcmtRangeMarks.BL{5} = [50 90];
BFB1b_sasLcmtRangeMarks.avgstdThld{5} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{6} = 'Mouse39_Locd_20250117_#7';
BFB1b_sasLcmtRangeMarks.LcmtReg{6} =[90 NaN];
BFB1b_sasLcmtRangeMarks.BL{6} = [1 20];
BFB1b_sasLcmtRangeMarks.avgstdThld{6} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{7} = 'Mouse39_Loce_20250117_#9';
BFB1b_sasLcmtRangeMarks.LcmtReg{7} =[80 90];
BFB1b_sasLcmtRangeMarks.BL{7} = [1 80];
BFB1b_sasLcmtRangeMarks.avgstdThld{7} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{8} = 'Mouse39_Loce_20250117_#10';
BFB1b_sasLcmtRangeMarks.LcmtReg{8} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{8} = [1 80];
BFB1b_sasLcmtRangeMarks.avgstdThld{8} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{9} = 'Mouse214_Loca_20250114_#4_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{9} =[70 NaN];
BFB1b_sasLcmtRangeMarks.BL{9} = [30 70];
BFB1b_sasLcmtRangeMarks.avgstdThld{9} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{10} = 'Mouse214_Loca_20250114_#4_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{10} =[70 NaN];
BFB1b_sasLcmtRangeMarks.BL{10} = [1 25];
BFB1b_sasLcmtRangeMarks.avgstdThld{10} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{11} = 'Mouse214_Locb_20250114_#11_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{11} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{11} = [1 90];
BFB1b_sasLcmtRangeMarks.avgstdThld{11} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{12} = 'Mouse214_Locb_20250114_#11_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{12} =[NaN NaN];
BFB1b_sasLcmtRangeMarks.BL{12} = [1 20;40 70;80 90];
BFB1b_sasLcmtRangeMarks.avgstdThld{12} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{13} = 'Mouse214_Locc_20250114_#16';
BFB1b_sasLcmtRangeMarks.LcmtReg{13} =[5 30];
BFB1b_sasLcmtRangeMarks.BL{13} = [1 40];
BFB1b_sasLcmtRangeMarks.avgstdThld{13} = 2;
BFB1b_sasLcmtRangeMarks.DataNames{14} = 'Mouse214_Locd_20250114_#19';
BFB1b_sasLcmtRangeMarks.LcmtReg{14} =[60 70;80 NaN];
BFB1b_sasLcmtRangeMarks.BL{14} = [1 30];
BFB1b_sasLcmtRangeMarks.avgstdThld{14} = 2;




BFB1b_psLcmtRangeMarks.DataNames{1} = 'Mouse15_Locb_20250117_#7';
BFB1b_psLcmtRangeMarks.LcmtReg{1} =[70 80];
BFB1b_psLcmtRangeMarks.BL{1} = [1 70];
BFB1b_psLcmtRangeMarks.avgstdThld{1} = 2;

BFB1b_psLcmtRangeMarks.DataNames{2} = 'Mouse15_Locb_20250117_#10';
BFB1b_psLcmtRangeMarks.LcmtReg{2} =[80 NaN];
BFB1b_psLcmtRangeMarks.BL{2} = [45 65];
BFB1b_psLcmtRangeMarks.avgstdThld{2} = 2;

BFB1b_psLcmtRangeMarks.DataNames{3} = 'Mouse15_Locc_20250117_#15';
BFB1b_psLcmtRangeMarks.LcmtReg{3} =[80 NaN];
BFB1b_psLcmtRangeMarks.BL{3} = [70 80];
BFB1b_psLcmtRangeMarks.avgstdThld{3} = 2;

BFB1b_psLcmtRangeMarks.DataNames{4} = 'Mouse15_Locc_20250117_#17_left';
BFB1b_psLcmtRangeMarks.LcmtReg{4} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{4} = [20 40];
BFB1b_psLcmtRangeMarks.avgstdThld{4} = 2;

BFB1b_psLcmtRangeMarks.DataNames{5} = 'Mouse15_Locc_20250117_#17_right';
BFB1b_psLcmtRangeMarks.LcmtReg{5} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{5} = [70 90];
BFB1b_psLcmtRangeMarks.avgstdThld{5} = 2;

BFB1b_psLcmtRangeMarks.DataNames{6} = 'Mouse15_Locc_20250117_#18_left';
BFB1b_psLcmtRangeMarks.LcmtReg{6} =[40 50];
BFB1b_psLcmtRangeMarks.BL{6} = [1 20];
BFB1b_psLcmtRangeMarks.avgstdThld{6} = 2;

BFB1b_psLcmtRangeMarks.DataNames{7} = 'Mouse15_Locc_20250117_#18_right';
BFB1b_psLcmtRangeMarks.LcmtReg{7} =[40 50];
BFB1b_psLcmtRangeMarks.BL{7} = [1 20];
BFB1b_psLcmtRangeMarks.avgstdThld{7} = 2;

BFB1b_psLcmtRangeMarks.DataNames{8} = 'Mouse39_Locb_20250117_#3_left';
BFB1b_psLcmtRangeMarks.LcmtReg{8} =[0.5 5];
BFB1b_psLcmtRangeMarks.BL{8} = [40 60];
BFB1b_psLcmtRangeMarks.avgstdThld{8} = 2;

BFB1b_psLcmtRangeMarks.DataNames{9} = 'Mouse39_Locb_20250117_#3_right';
BFB1b_psLcmtRangeMarks.LcmtReg{9} =[0.5 5];
BFB1b_psLcmtRangeMarks.BL{9} = [20 60];
BFB1b_psLcmtRangeMarks.avgstdThld{9} = 2;

BFB1b_psLcmtRangeMarks.DataNames{10} = 'Mouse39_Locd_20250117_#7_left';
BFB1b_psLcmtRangeMarks.LcmtReg{10} =[90 NaN];
BFB1b_psLcmtRangeMarks.BL{10} = [20 40];
BFB1b_psLcmtRangeMarks.avgstdThld{10} = 2;

BFB1b_psLcmtRangeMarks.DataNames{11} = 'Mouse39_Locd_20250117_#7_right';
BFB1b_psLcmtRangeMarks.LcmtReg{11} =[90 NaN];
BFB1b_psLcmtRangeMarks.BL{11} = [15 60];
BFB1b_psLcmtRangeMarks.avgstdThld{11} = 2;

BFB1b_psLcmtRangeMarks.DataNames{12} = 'Mouse39_Loce_20250117_#9_left';
BFB1b_psLcmtRangeMarks.LcmtReg{12} =[80 90];
BFB1b_psLcmtRangeMarks.BL{12} = [1 60];
BFB1b_psLcmtRangeMarks.avgstdThld{12} = 2;

BFB1b_psLcmtRangeMarks.DataNames{13} = 'Mouse39_Loce_20250117_#9_right';
BFB1b_psLcmtRangeMarks.LcmtReg{13} =[80 90];
BFB1b_psLcmtRangeMarks.BL{13} = [20 55];
BFB1b_psLcmtRangeMarks.avgstdThld{13} = 2;

BFB1b_psLcmtRangeMarks.DataNames{14} = 'Mouse39_Loce_20250117_#10_left';
BFB1b_psLcmtRangeMarks.LcmtReg{14} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{14} = [10 30];
BFB1b_psLcmtRangeMarks.avgstdThld{14} = 2;

BFB1b_psLcmtRangeMarks.DataNames{15} = 'Mouse39_Loce_20250117_#10_right';
BFB1b_psLcmtRangeMarks.LcmtReg{15} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{15} = [1 25];
BFB1b_psLcmtRangeMarks.avgstdThld{15} = 2;

BFB1b_psLcmtRangeMarks.DataNames{16} = 'Mouse39_Loce_20250117_#11_left';
BFB1b_psLcmtRangeMarks.LcmtReg{16} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{16} = [1 30];
BFB1b_psLcmtRangeMarks.avgstdThld{16} = 2;

BFB1b_psLcmtRangeMarks.DataNames{17} = 'Mouse39_Loce_20250117_#11_right';
BFB1b_psLcmtRangeMarks.LcmtReg{17} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{17} = [1 70];
BFB1b_psLcmtRangeMarks.avgstdThld{17} = 2;

BFB1b_psLcmtRangeMarks.DataNames{18} = 'Mouse214_Loca_20250114_#4';
BFB1b_psLcmtRangeMarks.LcmtReg{18} =[70 NaN];
BFB1b_psLcmtRangeMarks.BL{18} = [10 30];
BFB1b_psLcmtRangeMarks.avgstdThld{18} = 2;

BFB1b_psLcmtRangeMarks.DataNames{19} = 'Mouse214_Locb_20250114_#11';
BFB1b_psLcmtRangeMarks.LcmtReg{19} =[NaN NaN];
BFB1b_psLcmtRangeMarks.BL{19} = [50 90];
BFB1b_psLcmtRangeMarks.avgstdThld{19} = 2.5;

BFB1b_psLcmtRangeMarks.DataNames{20} = 'Mouse214_Locc_20250114_#16';
BFB1b_psLcmtRangeMarks.LcmtReg{20} =[5 30];
BFB1b_psLcmtRangeMarks.BL{20} = [1 50];
BFB1b_psLcmtRangeMarks.avgstdThld{20} = 2;

BFB1b_psLcmtRangeMarks.DataNames{21} = 'Mouse214_Locd_20250114_#19';
BFB1b_psLcmtRangeMarks.LcmtReg{21} =[60 70;80 NaN];
BFB1b_psLcmtRangeMarks.BL{21} = [1 60];
BFB1b_psLcmtRangeMarks.avgstdThld{21} = 2;
...
imagesc(AFBSCaCurvesCut,[0.9 1.4]); title('AFBS Ca');
...
imagesc(BFB1b_sasCaCurvesCut,[0.9 1.4]); title('BFB1b-sas Ca');
...
imagesc(BFB1b_psCaCurvesCut,[0.9 1.4]); title('BFB1b-ps Ca');
...
mylim=ylim;
PlotStatStars2(hd4,2,3,2,AFBS_DiamPeakAmp,BFB1b_sas_DiamPeakAmp,[1 2],mylim(2)*0.9,3);
PlotStatStars2(hd4,2,3,2,BFB1b_sas_DiamPeakAmp,BFB1b_ps_DiamPeakAmp,[2 3],mylim(2)*0.96,3);
PlotStatStars2(hd4,2,3,2,AFBS_DiamPeakAmp,BFB1b_ps_DiamPeakAmp,[1 3],mylim(2)*0.93,3);
