...
%% %% Parameter Settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Celltype='FB Locomotion New_NoAverage';
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Filepath{1} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\Locomotion\Arachnoid FBS';
Filepath{2} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\Locomotion\BFB1b FBs (SAS & Pia)';
Filepath{3} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\Locomotion\BFB1b FBs (Pial sheath)';


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Premark the time range of locomotion
AFBSLcmtRangeMarks.DataNames{1} = 'Mouse87_locb_20240219';
AFBSLcmtRangeMarks.LcmtReg{1} =[20 55];
AFBSLcmtRangeMarks.BL{1} = [13 21;60 80];
AFBSLcmtRangeMarks.DataNames{2} = 'Mouse87_locb2_20240219';
AFBSLcmtRangeMarks.LcmtReg{2} =[5 25];
AFBSLcmtRangeMarks.BL{2} = [50 150];
AFBSLcmtRangeMarks.DataNames{3} = 'Mouse144_loca_20240219';
AFBSLcmtRangeMarks.LcmtReg{3} =[8.5 34.5];
AFBSLcmtRangeMarks.BL{3} = [55 120];
AFBSLcmtRangeMarks.DataNames{4} = 'Mouse144_locb_20240219';
AFBSLcmtRangeMarks.LcmtReg{4} = [12.5 30];
AFBSLcmtRangeMarks.BL{4} = [50 70];
AFBSLcmtRangeMarks.DataNames{5} = 'Mouse156_locb3_20240221';
AFBSLcmtRangeMarks.LcmtReg{5} = [40 70;110 NaN];
AFBSLcmtRangeMarks.BL{5} = [20 40];
AFBSLcmtRangeMarks.DataNames{6} = 'Mouse160_loca_20240131';
AFBSLcmtRangeMarks.LcmtReg{6} = [6 22; 50 91];
AFBSLcmtRangeMarks.BL{6} = [30 55];
AFBSLcmtRangeMarks.DataNames{7} = 'Mouse160_loca_20240212';
AFBSLcmtRangeMarks.LcmtReg{7} = [20 30; 45 55];
AFBSLcmtRangeMarks.BL{7} = [37 46];
AFBSLcmtRangeMarks.DataNames{8} = 'Mouse166_loca_20240503';
AFBSLcmtRangeMarks.LcmtReg{8} = [25 42; 75 101];
AFBSLcmtRangeMarks.BL{8} = [5 30];
AFBSLcmtRangeMarks.DataNames{9} = 'Mouse166_loca_20240508';
AFBSLcmtRangeMarks.LcmtReg{9} = [55 80];
AFBSLcmtRangeMarks.BL{9} = [5 55];
AFBSLcmtRangeMarks.DataNames{10} = 'Mouse166_locb_20240508';
AFBSLcmtRangeMarks.LcmtReg{10} = [3.7 24];
AFBSLcmtRangeMarks.BL{10} = [0.8 6];


BFB1b_sasLcmtRangeMarks.DataNames{1} = 'Mouse77_locb_20240108_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{1} =[10 20;35 50];
BFB1b_sasLcmtRangeMarks.BL{1} = [1 12];
BFB1b_sasLcmtRangeMarks.DataNames{2} = 'Mouse87_locb_20240219_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{2} =[20 55];
BFB1b_sasLcmtRangeMarks.BL{2} = [1 13];
BFB1b_sasLcmtRangeMarks.DataNames{3} = 'Mouse87_locb_20240219_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{3} =[20 55];
BFB1b_sasLcmtRangeMarks.BL{3} = [13 21];
BFB1b_sasLcmtRangeMarks.DataNames{4} = 'Mouse87_locb2_20240219_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{4} =[5 25];
BFB1b_sasLcmtRangeMarks.BL{4} = [60 100];
BFB1b_sasLcmtRangeMarks.DataNames{5} = 'Mouse87_locb2_20240219_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{5} =[5 25];
BFB1b_sasLcmtRangeMarks.BL{5} = [60 155];
BFB1b_sasLcmtRangeMarks.DataNames{6} = 'Mouse144_loca_20240219_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{6} =[8.5 34.5];
BFB1b_sasLcmtRangeMarks.BL{6} = [1 10];
BFB1b_sasLcmtRangeMarks.DataNames{7} = 'Mouse144_locb_2040219_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{7} =[12.5 30];
BFB1b_sasLcmtRangeMarks.BL{7} = [1 10];
BFB1b_sasLcmtRangeMarks.DataNames{8} = 'Mouse144_locb_20240219_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{8} =[12.5 30];
BFB1b_sasLcmtRangeMarks.BL{8} = [60 80];
BFB1b_sasLcmtRangeMarks.DataNames{9} = 'Mouse156_loc1_20240221_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{9} =[3 25];
BFB1b_sasLcmtRangeMarks.BL{9} = [1 6];
BFB1b_sasLcmtRangeMarks.DataNames{10} = 'Mouse156_locb_20240129_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{10} =[10 20];
BFB1b_sasLcmtRangeMarks.BL{10} = [60 75];
BFB1b_sasLcmtRangeMarks.DataNames{11} = 'Mouse156_locb3_20240221_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{11} =[40 70;110 NaN];
BFB1b_sasLcmtRangeMarks.BL{11} = [20 40];
BFB1b_sasLcmtRangeMarks.DataNames{12} = 'Mouse156_locb3_20240221_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{12} =[40 70;110 NaN];
BFB1b_sasLcmtRangeMarks.BL{12} = [1 28.5];
BFB1b_sasLcmtRangeMarks.DataNames{13} = 'Mouse160_loca_20240131_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{13} =[5 20;50 100];
BFB1b_sasLcmtRangeMarks.BL{13} = [21 45];
BFB1b_sasLcmtRangeMarks.DataNames{14} = 'Mouse160_loca_20240212_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{14} =[20 30;45 55];
BFB1b_sasLcmtRangeMarks.BL{14} = [32 45];
BFB1b_sasLcmtRangeMarks.DataNames{15} = 'Mouse160_Loca_202240131_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{15} =[5 20;52 100];
BFB1b_sasLcmtRangeMarks.BL{15} = [22 47];
BFB1b_sasLcmtRangeMarks.DataNames{16} = 'Mouse166_loca_20240503_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{16} =[25 50;75 100];
BFB1b_sasLcmtRangeMarks.BL{16} = [20 30];
BFB1b_sasLcmtRangeMarks.DataNames{17} = 'Mouse166_loca_20240508_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{17} =[50 80];
BFB1b_sasLcmtRangeMarks.BL{17} = [1 60];
BFB1b_sasLcmtRangeMarks.DataNames{18} = 'Mouse166_loca_20240508_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{18} =[50 80];
BFB1b_sasLcmtRangeMarks.BL{18} = [1 60];



BFB1b_psLcmtRangeMarks.DataNames{1} = 'Mouse87_locb_20240219_whole';
BFB1b_psLcmtRangeMarks.LcmtReg{1} =[20 55];
BFB1b_psLcmtRangeMarks.BL{1} = [2 20];
BFB1b_psLcmtRangeMarks.DataNames{2} = 'Mouse87_locb2_20240219_whole';
BFB1b_psLcmtRangeMarks.LcmtReg{2} =[5 25];
BFB1b_psLcmtRangeMarks.BL{2} = [85 120];
BFB1b_psLcmtRangeMarks.DataNames{3} = 'Mouse144_loca_20240219_whole';
BFB1b_psLcmtRangeMarks.LcmtReg{3} =[8.5 34.5];
BFB1b_psLcmtRangeMarks.BL{3} = [80 100];
BFB1b_psLcmtRangeMarks.DataNames{4} = 'Mouse156_loc1_20240221_right';
BFB1b_psLcmtRangeMarks.LcmtReg{4} =[2.5 25];
BFB1b_psLcmtRangeMarks.BL{4} = [40 70];
BFB1b_psLcmtRangeMarks.DataNames{5} = 'Mouse156_locb_20240401_whole';
BFB1b_psLcmtRangeMarks.LcmtReg{5} =[28 50];
BFB1b_psLcmtRangeMarks.BL{5} = [10 30];
BFB1b_psLcmtRangeMarks.DataNames{6} = 'Mouse156_locc_20240205_whole';
BFB1b_psLcmtRangeMarks.LcmtReg{6} =[10 40];
BFB1b_psLcmtRangeMarks.BL{6} = [1 11];
BFB1b_psLcmtRangeMarks.DataNames{7} = 'Mouse166_loca_20240503_left';
BFB1b_psLcmtRangeMarks.LcmtReg{7} =[25 50;75 100];
BFB1b_psLcmtRangeMarks.BL{7} = [20 30];
BFB1b_psLcmtRangeMarks.DataNames{8} = 'Mouse166_loca_20240510_whole';
BFB1b_psLcmtRangeMarks.LcmtReg{8} =[50 80];
BFB1b_psLcmtRangeMarks.BL{8} = [1 30];
BFB1b_psLcmtRangeMarks.DataNames{9} = 'Mouse166_locb_20240508_whole';
BFB1b_psLcmtRangeMarks.LcmtReg{9} =[3.7 24];
BFB1b_psLcmtRangeMarks.BL{9} = [50 100];
