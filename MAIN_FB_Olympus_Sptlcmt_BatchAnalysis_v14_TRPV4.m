...
%% %% Parameter Settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Celltype='FB Locomotion New_NoAverage_TRPV4 blocker';
...
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Filepath{1} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\Locomotion\OneUMGSK219\Arachnoid FBS';
Filepath{2} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\Locomotion\OneUMGSK219\Subarachnoid';
Filepath{3} = 'D:\ChangsiCai\Chen He\1Chens projects\Fibroblasts\Locomotion\OneUMGSK219\Endfeet';


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Premark the time range of locomotion
AFBSLcmtRangeMarks.DataNames{1} = 'Mouse180_Loca_20241120_no1';
AFBSLcmtRangeMarks.LcmtReg{1} =[30 50];
AFBSLcmtRangeMarks.BL{1} = [20 34];
AFBSLcmtRangeMarks.DataNames{2} = 'Mouse180_Loca_20241120_no4';
AFBSLcmtRangeMarks.LcmtReg{2} =[20 50];
AFBSLcmtRangeMarks.BL{2} = [1 20];
AFBSLcmtRangeMarks.DataNames{3} = 'Mouse180_Locb_20241120_no6';
AFBSLcmtRangeMarks.LcmtReg{3} =[35 57];
AFBSLcmtRangeMarks.BL{3} = [10 40];
AFBSLcmtRangeMarks.DataNames{4} = 'Mouse180_Locd_20241120_no15';
AFBSLcmtRangeMarks.LcmtReg{4} = [60 80];
AFBSLcmtRangeMarks.BL{4} = [10 40];
AFBSLcmtRangeMarks.DataNames{5} = 'Mouse182_Loca_20241120_no3';
AFBSLcmtRangeMarks.LcmtReg{5} = [85 111];
AFBSLcmtRangeMarks.BL{5} = [65 85];
AFBSLcmtRangeMarks.DataNames{6} = 'Mouse182_Locb_20241120_no7';
AFBSLcmtRangeMarks.LcmtReg{6} = [15 40];
AFBSLcmtRangeMarks.BL{6} = [1 18];
AFBSLcmtRangeMarks.DataNames{7} = 'Mouse182_Locc_20241120_no10';
AFBSLcmtRangeMarks.LcmtReg{7} = [5 22; 50 70];
AFBSLcmtRangeMarks.BL{7} = [30 50];
AFBSLcmtRangeMarks.DataNames{8} = 'Mouse182_Locd_20241120_no13';
AFBSLcmtRangeMarks.LcmtReg{8} = [80 110];
AFBSLcmtRangeMarks.BL{8} = [60 85];
AFBSLcmtRangeMarks.DataNames{9} = 'Mouse190_Loca_20241121_no5';
AFBSLcmtRangeMarks.LcmtReg{9} = [40 60];
AFBSLcmtRangeMarks.BL{9} = [21 44];
AFBSLcmtRangeMarks.DataNames{10} = 'Mouse190_Locb_20241121_no6';
AFBSLcmtRangeMarks.LcmtReg{10} = [10 35];
AFBSLcmtRangeMarks.BL{10} = [30 50];
AFBSLcmtRangeMarks.DataNames{11} = 'Mouse190_Locc_20241121_no11';
AFBSLcmtRangeMarks.LcmtReg{11} = [2 15;17 40;100 120];
AFBSLcmtRangeMarks.BL{11} = [40 60];


BFB1b_sasLcmtRangeMarks.DataNames{1} = 'Mouse180_Loca_20241120_no1_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{1} =[30 50];
BFB1b_sasLcmtRangeMarks.BL{1} = [1 20];
BFB1b_sasLcmtRangeMarks.DataNames{2} = 'Mouse180_Loca_20241120_no1_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{2} =[30 50];
BFB1b_sasLcmtRangeMarks.BL{2} = [1 20];
BFB1b_sasLcmtRangeMarks.DataNames{3} = 'Mouse180_Loca_20241120_no4_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{3} =[20 50];
BFB1b_sasLcmtRangeMarks.BL{3} = [1 20];
BFB1b_sasLcmtRangeMarks.DataNames{4} = 'Mouse180_Loca_20241120_no4_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{4} =[20 50];
BFB1b_sasLcmtRangeMarks.BL{4} = [1 20];
BFB1b_sasLcmtRangeMarks.DataNames{5} = 'Mouse180_Locb_20241120_no6';
BFB1b_sasLcmtRangeMarks.LcmtReg{5} =[40 55];
BFB1b_sasLcmtRangeMarks.BL{5} = [10 40];
BFB1b_sasLcmtRangeMarks.DataNames{6} = 'Mouse180_Locd_20241120_no15';
BFB1b_sasLcmtRangeMarks.LcmtReg{6} =[60 77];
BFB1b_sasLcmtRangeMarks.BL{6} = [10 40];
BFB1b_sasLcmtRangeMarks.DataNames{7} = 'Mouse182_Loca_20241120_no3';
BFB1b_sasLcmtRangeMarks.LcmtReg{7} =[90 120];
BFB1b_sasLcmtRangeMarks.BL{7} = [65 85];
BFB1b_sasLcmtRangeMarks.DataNames{8} = 'Mouse182_locb_20241120_no7_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{8} =[15 40];
BFB1b_sasLcmtRangeMarks.BL{8} = [1 14];
BFB1b_sasLcmtRangeMarks.DataNames{9} = 'Mouse182_locb_20241120_no7_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{9} =[15 40];
BFB1b_sasLcmtRangeMarks.BL{9} = [1 14];
BFB1b_sasLcmtRangeMarks.DataNames{10} = 'Mouse182_locc_20241120_no10_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{10} =[5 20;50 70];
BFB1b_sasLcmtRangeMarks.BL{10} = [25 50];
BFB1b_sasLcmtRangeMarks.DataNames{11} = 'Mouse182_locc_20241120_no10_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{11} =[5 20;50 70];
BFB1b_sasLcmtRangeMarks.BL{11} = [25 50];
BFB1b_sasLcmtRangeMarks.DataNames{12} = 'Mouse182_locd_20241120_no13';
BFB1b_sasLcmtRangeMarks.LcmtReg{12} =[80 120];
BFB1b_sasLcmtRangeMarks.BL{12} = [60 80];
BFB1b_sasLcmtRangeMarks.DataNames{13} = 'Mouse190_Loca_20241121_no5_left';
BFB1b_sasLcmtRangeMarks.LcmtReg{13} =[40 80];
BFB1b_sasLcmtRangeMarks.BL{13} = [21 44];
BFB1b_sasLcmtRangeMarks.DataNames{14} = 'Mouse190_Loca_20241121_no5_right';
BFB1b_sasLcmtRangeMarks.LcmtReg{14} =[40 80];
BFB1b_sasLcmtRangeMarks.BL{14} = [21 44];
BFB1b_sasLcmtRangeMarks.DataNames{15} = 'Mouse190_Locb_20241121_no6';
BFB1b_sasLcmtRangeMarks.LcmtReg{15} =[10 40];
BFB1b_sasLcmtRangeMarks.BL{15} = [1 10];
BFB1b_sasLcmtRangeMarks.DataNames{16} = 'Mouse190_Locc_20241121_no11';
BFB1b_sasLcmtRangeMarks.LcmtReg{16} =[2 15;17 40;100 120];
BFB1b_sasLcmtRangeMarks.BL{16} = [60 100];



BFB1b_psLcmtRangeMarks.DataNames{1} = 'Mouse180_Loca_20241120_no1';
BFB1b_psLcmtRangeMarks.LcmtReg{1} =[30 50];
BFB1b_psLcmtRangeMarks.BL{1} = [20 30];
BFB1b_psLcmtRangeMarks.DataNames{2} = 'Mouse180_Loca_20241120_no4';
BFB1b_psLcmtRangeMarks.LcmtReg{2} =[20 50];
BFB1b_psLcmtRangeMarks.BL{2} = [1 19];
BFB1b_psLcmtRangeMarks.DataNames{3} = 'Mouse180_Locb_20241120_no6';
BFB1b_psLcmtRangeMarks.LcmtReg{3} =[40 55];
BFB1b_psLcmtRangeMarks.BL{3} = [15 39];
BFB1b_psLcmtRangeMarks.DataNames{4} = 'Mouse180_Locd_20241120_no15';
BFB1b_psLcmtRangeMarks.LcmtReg{4} =[60 77];
BFB1b_psLcmtRangeMarks.BL{4} = [10 40];
BFB1b_psLcmtRangeMarks.DataNames{5} = 'Mouse182_Loca_20241120_no3';
BFB1b_psLcmtRangeMarks.LcmtReg{5} =[90 120];
BFB1b_psLcmtRangeMarks.BL{5} = [65 85];
BFB1b_psLcmtRangeMarks.DataNames{6} = 'Mouse182_Locb_20241120_no7';
BFB1b_psLcmtRangeMarks.LcmtReg{6} =[15 40];
BFB1b_psLcmtRangeMarks.BL{6} = [40 60];
BFB1b_psLcmtRangeMarks.DataNames{7} = 'Mouse182_Locc_20241120_no10';
BFB1b_psLcmtRangeMarks.LcmtReg{7} =[5 22; 50 70];
BFB1b_psLcmtRangeMarks.BL{7} = [30 50];
BFB1b_psLcmtRangeMarks.DataNames{8} = 'Mouse182_Locd_20241120_no13';
BFB1b_psLcmtRangeMarks.LcmtReg{8} =[80 110];
BFB1b_psLcmtRangeMarks.BL{8} = [60 80];
BFB1b_psLcmtRangeMarks.DataNames{9} = 'Mouse190_Loca_20241121_no5';
BFB1b_psLcmtRangeMarks.LcmtReg{9} =[40 80];
BFB1b_psLcmtRangeMarks.BL{9} = [21 44];
BFB1b_psLcmtRangeMarks.DataNames{10} = 'Mouse190_Locb_20241121_no6';
BFB1b_psLcmtRangeMarks.LcmtReg{10} =[10 40];
BFB1b_psLcmtRangeMarks.BL{10} = [1 10];
BFB1b_psLcmtRangeMarks.DataNames{11} = 'Mouse190_Locc_20241121_no11';
BFB1b_psLcmtRangeMarks.LcmtReg{11} =[2 15;17 40;100 120];
BFB1b_psLcmtRangeMarks.BL{11} = [60 100];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
PreDurt = -15;   %%%%%%% the perios used as baseline
...
yyaxis left
stdshade_changsi_v2(BFB1b_sas.DiamTraceAll(1:BFB1b_sas.LcmtCountNum,:),0.5,DiamColor(1),LcmtBin_Time);
...
plot(LcmtBin_Time,mean(BFB1b_sas.DiamTraceAll(1:BFB1b_sas.LcmtCountNum,:)),'b-');
...
stdshade_changsi_v2(BFB1b_sas.DiamTraceAll(1:BFB1b_sas.LcmtCountNum,:),0.5,'b',LcmtBin_Time);
...
plot(LcmtBin_Time,mean(BFB1b_sas.CaTraceAll(1:BFB1b_sas.LcmtCountNum,:)),'b-');
...
stdshade_changsi_v2(BFB1b_sas.CaTraceAll(1:BFB1b_sas.LcmtCountNum,:),0.5,'b',LcmtBin_Time);
