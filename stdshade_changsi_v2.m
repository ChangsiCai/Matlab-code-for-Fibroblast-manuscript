function stdshade_changsi_v2(amatrix,alpha,acolor,F,smth)
...
if exist('alpha','var')==0 || isempty(alpha) 
    ...
    fill([F fliplr(F)],[amean+astd fliplr(amean-astd)],acolor, 'FaceAlpha', alpha,'linestyle','none','Marker','none');
end
...
hold on;plot(F,amean,acolor,'linewidth',1.5,'LineStyle','-','Marker','none'); %% change color or linewidth to adjust mean line
